...
public class DiscussziyuanxinxiController {
    ...
    public R security(@RequestParam String username){
        DiscussziyuanxinxiEntity discussziyuanxinxi = discussziyuanxinxiService.selectOne(new EntityWrapper<DiscussziyuanxinxiEntity>().eq("", username));
        return R.ok().put("data", discussziyuanxinxi);
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussziyuanxinxiEntity discussziyuanxinxi, HttpServletRequest request,String pre){
        EntityWrapper<DiscussziyuanxinxiEntity> ew = new EntityWrapper<DiscussziyuanxinxiEntity>();
