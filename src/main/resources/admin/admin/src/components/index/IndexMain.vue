<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0px 0 0 56px","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20230807/bc751527d2454c82a345e91b17a44608.jpg) no-repeat center top / cover","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 260px","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20230807/bc751527d2454c82a345e91b17a44608.jpg) no-repeat center top / cover","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 0px 0 0 rgba(0,0,0,.01), 0 0px 0px 0 rgba(0,0,0,.06)","padding":"8px 190px 8px 280px","margin":"0 auto","borderColor":"#f6dce0","alignItems":"center","color":"#fff","display":"flex","justifyContent":"space-between","background":"none","borderWidth":"0 0 0px","width":"calc(100% - 0px)","fontSize":"16px","position":"relative","borderStyle":"solid","zIndex":"1002","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"50px 0 0","margin":"0px auto","borderColor":"#eee","borderWidth":"0 0 0px","background":"url(http://codegen.caihongy.cn/20230808/17a3022c73d8418f80afb7963cd2d939.png) no-repeat left top,#f5f5f5","width":"calc(100% - 60px)","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
